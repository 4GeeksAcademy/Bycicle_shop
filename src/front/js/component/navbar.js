				...
				return (
					<nav className="navbar navbar-dark navbar-expand-lg fixed-top">
						<div className="container-fluid d-flex">
							...
							<div class="dropdown mb-3 language">
								<button className="btnlanguage dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
								...
								<ul className="dropdown-language dropdown-menu">
									...
									<br /> 
									<button className="form-btn" href="#">APPLY</button>
								</ul>
							</div>
